...
\newcommand{\MetaVar}[1]{\textbf{$\mathbb{#1}$}}

\newcommand{\ContextVarA}{$\Gamma$}
\newcommand{\ContextVarB}{$\Delta$}
\newcommand{\ContextVarC}{$\Theta$}
\newcommand{\ContextVarD}{$\Phi$}

\newcommand{\BindingVarX}{$\alpha$}
\newcommand{\ContextVarY}{$\beta$}
